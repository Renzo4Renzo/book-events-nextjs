...
const EventDetailsPage = async ({ params }: { params: Promise<{ slug: string }> }) => {
  ...
  const { event: eventSelected } = await request.json();
  const { description, image, overview, date, time, location, mode, agenda, audience, tags, organizer } = eventSelected;
      ...
      <div className="details">
        ...
        <aside className="booking">
          <div className="signup-card">
            ...
            <BookEvent eventId={eventSelected._id} slug={slug} />
          </div>
        </aside>
      </div>
